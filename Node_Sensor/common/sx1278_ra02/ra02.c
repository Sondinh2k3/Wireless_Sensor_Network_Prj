...
/**
 * Variable Name: Mode => In table page 108
 */
...
/*
 * PA configuration
 Power Amplifier Configuration: Thiết lập và điều chỉnh công suất phát
 */
...
#define CONFIG_CS_GPIO 15 // Chân chip select (NSS)
